...
class HardeningProducaoTests(BaseFinanceTestCase):
    ...
    def test_login_substitui_registro_de_ip_anterior_do_mesmo_usuario(self):
        self.client.logout()
        ...
        critical_cache_set(
            ...
            {"ip": "189.1.1.1", "session_key": "sessao-anterior"},
            timeout=3600,
        )
    ...
    def test_login_remove_trava_fantasma_do_mesmo_usuario(self):
        self.client.logout()
